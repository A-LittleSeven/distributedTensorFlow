...
def LeNet(imgs, n_classes, mode):
    ...
    with tf.name_scope("input") as scope:
        ...
        input_layer = tf.reshape(imgs, [-1, 28, 28, 1], name=scope)
    ...
    with tf.name_scope("fc1") as scope:
        ...
        dense = tf.layers.dense(inputs=pool2_flat, units=1024, activation=tf.nn.relu, name=scope)
    ...
    with tf.name_scope("inference") as scope:
        ...
        logits = tf.layers.dense(inputs=dropout, units=n_classes, name=scope)
    return logits
